...
void createFunctions( JsonArray& functionsJson,String id,int type){
  ...
  switch(type){
    case LDR_TYPE:
    createFunctionArray(functionsJson,"Sensor de Luz","ligth_sensor","",MQTT_STATE_TOPIC_BUILDER(id,SENSOR_DEVICE,"ligth_sensor"),false,ANALOG_FUNCTION);
    break;
    case PIR_TYPE:
    createFunctionArray(functionsJson,"Movimento","motion","C",MQTT_STATE_TOPIC_BUILDER(id,SENSOR_DEVICE,"motion"),false,MOTION_FUNCTION);
    break;
    case DS18B20_TYPE:
    createFunctionArray(functionsJson,"Temperatura","temperature","ºC",MQTT_STATE_TOPIC_BUILDER(id,SENSOR_DEVICE,"temperature"),false,TEMPERATURE_FUNCTION);
    break;
    case DHT_TYPE_11:
    case DHT_TYPE_21:
    case DHT_TYPE_22:
