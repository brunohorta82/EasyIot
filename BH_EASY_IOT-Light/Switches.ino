...
void switchJson(String _id,int _gpio ,int _gpioOpen ,int _gpioClose ,String _typeControl, int _gpioControl,int _gpioControlOpen,int _gpioControlClose, bool _stateControl,  String _name, bool _pullup, bool _state, int _mode, bool _master,String _type){
...
void createDefaultSwitchs(int type){
    ...
    if(type == EASY_LIGHT){    
      ...
      switchJson(id1,0,SWITCH_ONE,SWITCH_TWO,RELAY_TYPE,0,RELAY_ONE,RELAY_TWO,INIT_STATE_OFF,"Interruptor", BUTTON_SET_PULLUP,INIT_STATE_OFF,  OPEN_CLOSE_SWITCH, BUTTON_MASTER, MQTT_STATE_TOPIC_BUILDER(id1,SWITCH_DEVICE), MQTT_COMMAND_TOPIC_BUILDER(id1,SWITCH_DEVICE), "cover");
   }
}
